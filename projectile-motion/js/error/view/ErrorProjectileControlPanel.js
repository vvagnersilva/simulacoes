 ...
 * @constructor
 */
function ErrorProjectileControlPanel( comboBoxListParent, keypadLayer, model, options ) {
...
projectileMotion.register( 'ErrorProjectileControlPanel', ErrorProjectileControlPanel );

inherit( Panel, ErrorProjectileControlPanel, {
...
export default ErrorProjectileControlPanel;
