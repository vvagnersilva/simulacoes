...
import ErrorProjectileControlPanel from './ErrorProjectileControlPanel.js';
 ...
 * @constructor
 */
function ErrorScreenView( model, tandem, options ) {
  ...
  const labProjectilePanel = new ErrorProjectileControlPanel(
    comboBoxListParent,
    keypadLayer,
    model,
...
projectileMotion.register( 'ErrorScreenView', ErrorScreenView );

inherit( ProjectileMotionScreenView, ErrorScreenView, {
